  ...
  (list
   ...
   (list "blog"
      ...
      (list "ai_ml"
         ...
         :base-extension "org"
         :recursive t
         :publishing-directory (expand-file-name "public/posts/ai_ml" (projectile-project-root))
         :publishing-function 'duncan/org-html-publish-post-to-html
         :section-numbers nil
         :with-toc nil
         :html-preamble t
         ...
         :html-head-include-default-style nil
         :auto-sitemap t
         :sitemap-filename "ai_ml.org"
	 :sitemap-title "Posts on AI/ML"
         :sitemap-style 'list
         :sitemap-title nil
         :sitemap-sort-files 'anti-chronologically
         :sitemap-function 'duncan/latest-posts-sitemap-function
	 ...
	 :title "Posts on AI/ML")
      (list "philosophy"
         ...
         :base-extension "org"
         :recursive t
         :publishing-directory (expand-file-name "public/posts/philosophy" (projectile-project-root))
         :publishing-function 'duncan/org-html-publish-post-to-html
         :section-numbers nil
         :with-toc nil
         :html-preamble t
         ...
         :html-head-include-default-style nil
         :auto-sitemap t
         :sitemap-filename "philosophy.org"
	 :sitemap-title "Posts on Philosophy"
         :sitemap-style 'list
         :sitemap-title nil
         :sitemap-sort-files 'anti-chronologically
         :sitemap-function 'duncan/latest-posts-sitemap-function
	 ...
	 :title "Posts on Philosophy")
      (list "poetry"
         ...
         :base-extension "org"
         :recursive t
         :publishing-directory (expand-file-name "public/posts/poetry" (projectile-project-root))
         :publishing-function 'duncan/org-html-publish-post-to-html
         :section-numbers nil
         :with-toc nil
         :html-preamble t
         ...
         :html-head-include-default-style nil
         :auto-sitemap t
         :sitemap-filename "poetry.org"
	 :sitemap-title "Posts on Poetry"
         :sitemap-style 'list
         :sitemap-title nil
         :sitemap-sort-files 'anti-chronologically
         :sitemap-function 'duncan/latest-posts-sitemap-function
	 ...
	 :title "Posts on Poetry")
       ...
       (list "physics"
         :base-directory "./posts/physics"
         :exclude (regexp-opt my-excluded-files)
         :base-extension "org"
         :recursive t
         :publishing-directory (expand-file-name "public/posts/physics" (projectile-project-root))
         :publishing-function 'duncan/org-html-publish-post-to-html
         :section-numbers nil
         :with-toc nil
         :html-preamble t
         ...
         :html-head-include-default-style nil
         :auto-sitemap t
         :sitemap-filename "physics.org"
	 :sitemap-title "Posts on Physics"
         :sitemap-style 'list
         :sitemap-title nil
         :sitemap-sort-files 'anti-chronologically
         :sitemap-function 'duncan/latest-posts-sitemap-function
	 ...
	 :title "Posts on Physics")
       ...
       (list "tutorials_list"
         ...
         :base-extension "org"
         :recursive t
         :publishing-directory (expand-file-name "public/posts/tutorials_list" (projectile-project-root))
         :publishing-function 'duncan/org-html-publish-post-to-html
         :section-numbers nil
         :with-toc nil
         :html-preamble t
         ...
         :html-head-include-default-style nil
         :auto-sitemap t
         :sitemap-filename "tutorials_list.org"
	 :sitemap-title "Tutorials & notes"
         :sitemap-style 'list
         :sitemap-title nil
         :sitemap-sort-files 'anti-chronologically
         :sitemap-function 'duncan/latest-posts-sitemap-function
